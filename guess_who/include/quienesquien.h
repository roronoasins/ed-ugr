	...
	*/
	...
	/**
	  * @brief Este m�todo permite calcular la media de la profundidad de las hojas del �rbol.
		* Este valor representa el n�mero (promedio) de preguntas necesarias para adivinar
		* cada personaje. A menor profundidad promedio, mejor soluci�n. Esta m�trica es un
		* indicador para evaluar la calidad de vuestra soluci�n.
	  *
	...
	/**
		* @brief ​ Muestra ​ una descripción​ ​ de​ ​ las​ ​ preguntas​ ​ formuladas​ ​ anteriormente
		* ​ ​ 			y ​ ​ las​ ​ respuestas​ dadas​ ​ por​ ​ el​ usuario​ ​ hasta​ ​ ahora.
		* 				Dado un estado del tablero devuelve los nombres de los personajes que
		*         aún no han sido tumbados en el tablero.
		*
		* @param jugada Momento del juego a consultar.
		*
		* @return Conjunto de personajes que no han sido tumbados en el tablero.
		*
		* @pre El arbol del QuienEsQuien receptor debe haber sido construido previamente.
	...
	/**
		* @brief ​ Inserta​ ​el​ personaje​ ​nuevo​ en​ el​ árbol​ ya construido
		* ​ ​ 			a partir​​ de​ su​ ​nombre​ y ​descripción​ ​ asociada​ ​ (vector<bool>).
		*
		* @param nombre Nombre del jugador a insertar en el árbol.
		* @param caracteristicas Descripcion asociada al jugador a insertar en el árbol.
		*
		* @return QuienEsQuien con un nuevo personaje de nombre pasado por parámetro.
		*
		* @pre El arbol del QuienEsQuien receptor debe haber sido construido previamente.
		*/
	...
	/**
		* @brief ​ Elimina un personaje del arbol de QuienEsQuien.
		*
		* @param nombre Nombre del jugador a eliminar.
		*
		* @return QuienEsQuien con un personaje eliminado de nombre pasado por parámetro.
		*
		* @pre El arbol del QuienEsQuien receptor debe haber sido construido previamente.
		*/
