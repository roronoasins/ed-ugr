...
\begin{DoxyParams}{Parámetros}
{\em nombre} & Nombre del jugador a insertar en el árbol. \\
\hline
{\em caracteristicas} & Descripcion asociada al jugador a insertar en el árbol.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Devuelve}
\hyperlink{classQuienEsQuien}{Quien\+Es\+Quien} con un nuevo personaje de nombre pasado por parámetro.
\end{DoxyReturn}
...
​ Elimina un personaje del arbol de \hyperlink{classQuienEsQuien}{Quien\+Es\+Quien}. 


\begin{DoxyParams}{Parámetros}
{\em nombre} & Nombre del jugador a eliminar.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Devuelve}
\hyperlink{classQuienEsQuien}{Quien\+Es\+Quien} con un personaje eliminado de nombre pasado por parámetro.
\end{DoxyReturn}
\begin{DoxyPrecond}{Precondición}
El arbol del \hyperlink{classQuienEsQuien}{Quien\+Es\+Quien} receptor debe haber sido construido previamente. 
\end{DoxyPrecond}
...
\begin{DoxyParams}{Parámetros}
{\em jugada} & Momento del juego a consultar.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Devuelve}
Conjunto de personajes que no han sido tumbados en el tablero.
